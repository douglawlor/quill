...
| Tier 2 | Flagship experience | 57 | 52 | 5 | OCR-3, AGENT-1, AI-19, SET-2, SET-3 |
...
| **1.0 subtotal** | Tiers 1, 2, 4, 6 (the QUILL 1.0 scope) | **143** | **90** | **53** | |
...
| --- | --- | --- |
| Tier 2 — Flagship | In progress | SET-2, SET-3, AGENT-1, OCR-3, AI-19 |
...
- **Still honestly open:** OCR-3's clipboard-image and screen-region capture sources are not yet built (only file capture ships), so OCR-3 stays In progress. SET-2 (no sensitivity-aware dictation backend; Win+H exposes no such control) and AI-19 (needs a live provider device-login endpoint) remain genuinely blocked even on Windows.
